...
public class ClusterAgeAgent extends Agent{
	@Override
	protected void setup() {
		...
		parallelBehaviour.addSubBehaviour(new OneShotBehaviour() {
			...
			public void action() {
				...
				WebTarget target = client.target("http://127.0.0.1:5000/visualisation/clusterAge");
				...
				aclMessage.setOntology("clusteringAge");
				send(aclMessage);
