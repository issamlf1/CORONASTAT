...
public class MhealthScrapingAgent extends Agent{
	@Override
	protected void setup() {
		...
		parallelBehaviour.addSubBehaviour(new OneShotBehaviour() {
			...
			public void action() {
				...
				WebTarget target = client.target("http://127.0.0.1:5000/analysesentiment/covid19/covid19/mentalhealth");
				...
				aclMessage.setOntology("mentalhealth");
				send(aclMessage);
			}
		});
